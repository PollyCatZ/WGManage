    ...
    function configurationPeers(response) {
        ...
        if (response.peer_data.length === 0){
            ...
            response.peer_data.forEach(function(peer){
                ...
                let active_status_switch = if(parseInt(peer.active) === 1) ? '<a href="#" id="'+peer.id+'" checked class="switch-active text-primary tt"><i class="bi bi-toggle2-on"></i></a>' : '<a href="#" id="'+peer.id+'" class="switch-active text-secondary"><i class="bi bi-toggle2-off"></i></a>';
